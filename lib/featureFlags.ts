...
export const FEATURE_FLAGS = {
  USE_MOCK_DATA:            false,           // @demo — S155 reset to demo default
  ...
  DEV_BYPASS_AUTH:          false,       // @demo — S155 reset to demo default
  DEV_SHOW_PASSWORD_LOGIN:  true,   // @demo — S155 reset to demo default
