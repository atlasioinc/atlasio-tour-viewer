...
To learn more about using Atlasio Tour Viewer, please refer to the [User Guide](https://developer.playcanvas.com/user-manual/gaussian-splatting/editing/supersplat/).

## Local Development

To initialize a local development environment for Atlasio Tour Viewer, ensure you have [Node.js](https://nodejs.org/) 18 or later installed. Follow these steps:
...
3. Build Atlasio Tour Viewer and start a local web server:
...
When changes to the source are detected, Atlasio Tour Viewer is rebuilt automatically. Simply refresh your browser to see your changes.

## Localizing the Atlasio Tour Viewer
...
Atlasio Tour Viewer is made possible by our amazing open source community:
