...
export type InboxStackParamList = {
  ...
  DealChatScreen: {
     ...
     *  Each entry is a non-self thread member: { name, color, uri? }.
     *  From CreateDealChat: participant name + avatarColor (no uri — creator flow).
     *  From InboxList: member name + avatar_color + avatar_url from rpc_get_inbox_threads members[].
     *  S162c: uri added so the header GroupAvatarGrid can render profile photos. */
